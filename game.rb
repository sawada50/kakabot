...
#  end
  ...
  def getBotAnswer(lastChar) 
    bot = {
      "あ"=>"あーそうだねー",
      "い"=>"いいと思うよ",
      "う"=>"<font size=\"2\" color=\"blue\">うん、まぁまぁかな</font>",
      "え"=>"えっとね、そうだね",
      "お"=>"おーさすがだね",
      "か"=>"<font size=\"6\" color=\"red\">元気ですよ</font>",
      "き"=>"そうだよー",
      "く"=>"お肉たべる",
      "け"=>"元気ですよ",
      "こ"=>"いいよー",
      ...
      "て"=>"てんてん",
      "と"=>"あとまわし",
      "な"=>"<font size=\"7\" color=\"red\">よろしくおねがいしまああああああああああああああああああああああああああああああああああああああああす</font>",
      "に"=>"にんにん",
      "ぬ"=>"ぬま",
      "ね"=>"<font size=\"4\" color=\"orange\">またねー</font>",
      "の"=>"のんきなもんだな",
      "は"=>"はいはい",
      "ひ"=>"ひよわ",
      "ふ"=>"不意にはこまる",
